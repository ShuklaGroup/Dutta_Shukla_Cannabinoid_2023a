...
def two_D_free_energy(x_data,y_data,weights):
    ...
    plt.savefig('./Main_Figure_5B.png',transparent=False,dpi =300)
    

if __name__=='__main__':       
    data = pickle.load(open('Main_Figure_5B.pkl','rb'))

    x_data = data[0]
    y_data = data[1]

    dtrajs = pickle.load(open('CB1_classical_dtrajs.pkl','rb'))
    ...
    tram_obj = pickle.load(open('CB1_classical_tram_obj.pkl','rb'))
