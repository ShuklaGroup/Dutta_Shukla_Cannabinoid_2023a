...
def contact_freq_reader(state,bt,contact):
    resid = '324'
    filename = './frequency_files/CB1_classical_' + state + '_' + str(bt) + '_contact_freq.tsv'
...
def heatmap(contact,stable_residues):
    ...
    axs.set_xticklabels(['I1','Bound','I2','I3'],rotation = 30,**hfont,fontsize=16)
    plt.tight_layout()
    plt.savefig('./Main_Figure_7A.png',transparent=False,dpi =300)
