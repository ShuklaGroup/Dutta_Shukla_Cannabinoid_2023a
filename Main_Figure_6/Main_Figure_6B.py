...
def TPT_bt(A,B):
    filenames = glob.glob('./tram_files/CB1_nps_95_bt_[0-2]_tram_msm_obj.pkl')
    timescale = [] 
...
if __name__=='__main__':
    timescales = []
    macro_ind = {'Bound':0,'I1':1,'I2':4,'I3':3,'Unbound':-1}
    Intial_state = ['Bound','Bound','I1','I1','I2','I3','I2','I3','Unbound','Unbound']
    Final_state = ['I1','I2','I3','Bound','Bound','I1','Unbound','Unbound','I2','I3']

    for I,F in zip(Intial_state,Final_state):
        macrostates = pickle.load(open('./CB1_nps_TRAM_macrostate_clusters.pkl','rb'))
